<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/AdminMaster.master" AutoEventWireup="true" CodeBehind="EmpRegisThana.aspx.cs" Inherits="CCMS.Dashboard.EmpRegisThana" %>
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:DropDownList ID="ddl_kotwali" CssClass="form-control form-control-user" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_kotwali_SelectedIndexChanged"></asp:DropDownList>
        ...
        <asp:DropDownList ID="ddl_thana" CssClass="form-control form-control-user" runat="server"></asp:DropDownList>
    </div>
     </ContentTemplate>
        </asp:UpdatePanel>
