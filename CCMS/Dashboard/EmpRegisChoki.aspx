<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/AdminMaster.master" AutoEventWireup="true" CodeBehind="EmpRegisChoki.aspx.cs" Inherits="CCMS.Dashboard.EmpRegisChoki" %>
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:DropDownList ID="ddl_choki" CssClass="form-control form-control-user" runat="server"></asp:DropDownList>
    </div>
     </ContentTemplate>
        </asp:UpdatePanel>
